        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="flex items-start gap-3.5">
              ...
              <div>
                <h4 className="text-slate-900 dark:text-white font-semibold text-sm">Instant Price Quote</h4>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Algorithm-backed fair market pricing in under 60 seconds.</p>
              </div>
            </div>

            <div className="flex items-start gap-3.5">
              <div className="p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-500/30 text-emerald-600 dark:text-emerald-400 shrink-0">
            ...
            <div className="flex items-start gap-3.5">
              <div className="p-2.5 rounded-xl bg-blue-50 dark:bg-blue-950/60 border border-blue-200 dark:border-blue-500/30 text-blue-600 dark:text-blue-400 shrink-0">
                <ShieldCheck className="w-5 h-5" />
              </div>
              <div>
                <h4 className="text-slate-900 dark:text-white font-semibold text-sm">Instant Doorstep Payout</h4>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Direct UPI / IMPS transferred on the spot before agent leaves.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="space-y-3">
            <h5 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">Sell Your Device</h5>
            <ul className="space-y-2 text-xs">
              <li><Link href="/sell/smartphones" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">Sell Smartphone</Link></li>
              <li><Link href="/sell/laptops" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">Sell Laptop</Link></li>
              <li><Link href="/sell/smartphones/apple" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">Sell Apple iPhone</Link></li>
              <li><Link href="/sell/smartphones/samsung" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">Sell Samsung Galaxy</Link></li>
              <li><Link href="/sell/laptops/apple-macbook" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">Sell MacBook Air / Pro</Link></li>
              <li><Link href="/sell/laptops/dell" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">Sell Dell Laptop</Link></li>
              <li><Link href="/sell" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors font-medium text-cyan-600 dark:text-cyan-400">Browse All Brands →</Link></li>
            </ul>
          </div>

          {/* Company */}
          <div className="space-y-3">
            <h5 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">Company & Info</h5>
            <ul className="space-y-2 text-xs">
          ...
          {/* Support & Legal */}
          <div className="space-y-3">
            <h5 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">Support & Legal</h5>
            <ul className="space-y-2 text-xs">
              <li><Link href="/faqs" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">Frequently Asked Questions</Link></li>
              ...
              <li><Link href="/account" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">Customer Account</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-slate-200 dark:border-slate-900 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <span>•</span>
            <Link href="/terms" className="hover:text-slate-700 dark:hover:text-slate-400">Terms</Link>
            <span>•</span>
            <Link href="/faqs" className="hover:text-slate-700 dark:hover:text-slate-400">FAQs</Link>
            <span>•</span>
            <span className="text-cyan-600 dark:text-cyan-500 font-medium">Made for India 🇮🇳</span>
          </div>
        </div>
      </div>
    </footer>
